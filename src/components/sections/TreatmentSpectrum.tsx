          ...
          {spectrumData.map((item, idx) => (
            ...
            >
              ...
              {openPopover === idx && (
                <div
                  id={`popover-${idx}`}
                  className="absolute z-20 left-1/2 -translate-x-1/2 -top-4 md:-top-6 min-w-[200px] max-w-sm bg-white bg-opacity-95 border border-gray-200 shadow-xl rounded-xl px-5 py-4 text-sm text-gray-800 select-none pointer-events-none text-left leading-relaxed transition-all duration-200 opacity-100 scale-100"
